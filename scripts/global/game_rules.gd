...
var tower_descriptions = {
	...
	"FIRE_FIRE":			"Engulfs enemies in flames with high damage.",
	...
	"LIGHTNING_FIRE":			"Fires arcing bolts of energy.",
	...
	"PIERCING_FIRE":			"Launches flaming arrows that pierce targets.",
	...
	"SLASHING_FIRE":			"Ignites slashes with fiery energy.",
	...
	"BLUDGEONING_FIRE":			"Smashes enemies with fiery strikes.",
	...
	"HOLY_FIRE":				"Burns enemies with sacred fire.",
	...
	"SHADOW_FIRE":				"Corrupts enemies with dark fire.",
	...
	"MAGIC_FIRE":				"Burns enemies with magical fire.",
	...
	"COLD_FIRE":				"Chills enemies with icy fire.",
...
enum TOWER_TYPE {GROUND_EFFECT, FIRE, BEAM, MISSILE, SHIELD, ROCK}
